(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	(e, t, r) => {
		...
		const n = e.r(93504).createRenderSearchParamsFromClient;
		("function" == typeof r.default ||
			("object" == typeof r.default && null !== r.default)) &&
			void 0 === r.default.__esModule &&
			(Object.defineProperty(r.default, "__esModule", { value: !0 }),
	...
	(e, t, r) => {
		...
		const n = e.r(6831).createRenderParamsFromClient;
		("function" == typeof r.default ||
			("object" == typeof r.default && null !== r.default)) &&
			void 0 === r.default.__esModule &&
			(Object.defineProperty(r.default, "__esModule", { value: !0 }),
	...
	(e, t, r) => {
		Object.defineProperty(r, "__esModule", { value: !0 });
		var n = {
			InstantValidationError: () => s,
			isInstantValidationError: () => i,
		};
		for (var a in n) Object.defineProperty(r, a, { enumerable: !0, get: n[a] });
	...
	(e, t, r) => {
		...
		var n = {
			...
			createExhaustiveURLSearchParamsProxy: () => R,
	...
	(e, t, r) => {
		...
		var n = {
			...
			makeErroringSearchParamsForUseCache: () => O,
		};
		for (var a in n) Object.defineProperty(r, a, { enumerable: !0, get: n[a] });
		const o = e.r(63599),
			i = e.r(66373),
			...
			if (n)
				switch (n.type) {
					...
					case "validation-client":
						return ((t, r, n) => {
							var a;
							const { createExhaustiveSearchParamsProxy: o } = e.r(18450);
		...
		function v(t, r, n, a) {
			...
			if (n.validationSamples) {
				const { createExhaustiveSearchParamsProxy: a } = e.r(18450),
	...
	(e, t, r) => {
				...
				switch (s.type) {
					...
					case "request":
						if (s.asyncApiPromises && s.validationSamples)
							return ((t, r, n, a, o) => {
								const { createExhaustiveParamsProxy: i } = e.r(18450),
		...
		function R(t, r, n) {
			const { createExhaustiveParamsProxy: a } = e.r(18450);
			return Promise.resolve(
				a(
					t,
	...
	(e, t, r) => {
		...
		function l({ Component: t, serverProvidedParams: r }) {
			...
			if ("u" < typeof window) {
				...
				r = o(c);
				const { createParamsFromClient: i } = e.r(41489);
				return (a = i(u)), (0, n.jsx)(t, { params: a, searchParams: r });
			}
			{
				const { createRenderSearchParamsFromClient: r } = e.r(66996),
					a = r(c),
	...
	(e, t, r) => {
		...
		function i({ Component: t, slots: r, serverProvidedParams: s }) {
			...
			if ("u" < typeof window) {
				const { createParamsFromClient: a } = e.r(41489),
					o = a(l);
				return (0, n.jsx)(t, { ...r, params: o });
			}
			{
				const { createRenderParamsFromClient: a } = e.r(97689),
					o = a(l);
				return (0, n.jsx)(t, { ...r, params: o });
			}
		}
