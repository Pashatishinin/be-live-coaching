(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	(e, t, r) => {
		Object.defineProperty(r, "__esModule", { value: !0 });
		var n = { REDIRECT_ERROR_CODE: () => i, isRedirectError: () => u };
		for (var a in n) Object.defineProperty(r, a, { enumerable: !0, get: n[a] });
		const o = e.r(76963),
			i = "NEXT_REDIRECT";
		function u(e) {
	...
	(e, t, r) => {
		...
		const n = (0, e.r(90317).createAsyncLocalStorage)();
	},
	21768,
	(e, t, r) => {
		Object.defineProperty(r, "__esModule", { value: !0 });
		var n = {
			ACTION_HEADER: () => i,
			FLIGHT_HEADERS: () => g,
			NEXT_ACTION_NOT_FOUND_HEADER: () => O,
			NEXT_ACTION_REVALIDATED_HEADER: () => j,
			NEXT_DID_POSTPONE_HEADER: () => E,
			NEXT_HMR_REFRESH_HASH_COOKIE: () => d,
			NEXT_HMR_REFRESH_HEADER: () => l,
			NEXT_HTML_REQUEST_ID_HEADER: () => P,
			NEXT_INSTANT_PREFETCH_HEADER: () => m,
			NEXT_INSTANT_TEST_COOKIE: () => h,
			NEXT_IS_PRERENDER_HEADER: () => v,
			NEXT_REQUEST_ID_HEADER: () => S,
			NEXT_REWRITTEN_PATH_HEADER: () => b,
			NEXT_REWRITTEN_QUERY_HEADER: () => R,
			NEXT_ROUTER_PREFETCH_HEADER: () => s,
			NEXT_ROUTER_SEGMENT_PREFETCH_HEADER: () => c,
			NEXT_ROUTER_STALE_TIME_HEADER: () => _,
			NEXT_ROUTER_STATE_TREE_HEADER: () => u,
	...
	(e, t, r) => {
		Object.defineProperty(r, "__esModule", { value: !0 });
		var n,
			a = { RenderStage: () => s, StagedRenderingController: () => c };
	...
	(e, t, r) => {
		...
		var n = {
			AppRouterContext: () => i,
			GlobalLayoutRouterContext: () => s,
			LayoutRouterContext: () => u,
			MissingSlotContext: () => l,
			TemplateContext: () => c,
		};
		for (var a in n) Object.defineProperty(r, a, { enumerable: !0, get: n[a] });
		const o = e.r(55682)._(e.r(71645)),
	...
	(e, t, r) => {
		...
		const o = e.r(76963),
			i = e.r(68391),
			u = "u" < typeof window ? e.r(62266).actionAsyncStorage : void 0;
	...
	(e, t, r) => {
		...
		var n,
			...
			i = {
				...
				Postpone: () => D,
				PreludeState: () => eo,
				abortAndThrowOnSynchronousRequestDataAccess: () => T,
				abortOnSynchronousPlatformIOAccess: () => w,
				accessedDynamicData: () => L,
				annotateDynamicAccess: () => B,
				consumeDynamicAccess: () => U,
				createDynamicTrackingState: () => b,
				createDynamicValidationState: () => R,
				createHangingInputAbortSignal: () => H,
				createInstantValidationState: () => Z,
				createRenderInBrowserAbortSignal: () => X,
				formatDynamicAPIAccesses: () => $,
				getFirstDynamicReason: () => v,
				getNavigationDisallowedDynamicReasons: () => ec,
				getStaticShellDisallowedDynamicReasons: () => es,
				isDynamicPostpone: () => N,
				isPrerenderInterruptedError: () => k,
				logDisallowedDynamicError: () => ei,
				markCurrentScopeAsDynamic: () => O,
				postponeWithTracking: () => x,
				throwIfDisallowedDynamic: () => eu,
				throwToInterruptStaticGeneration: () => S,
				trackAllowedDynamicAccess: () => Q,
				trackDynamicDataInDynamicRender: () => P,
		...
		const s = (n = e.r(71645)) && n.__esModule ? n : { default: n },
			c = e.r(76353),
			l = e.r(43248),
			d = e.r(62141),
			f = e.r(63599),
...
${t}`
  ...
  - Rerun the production build with \`next build --debug-prerender\` to generate better stack traces.`);
		...
		function eu(e, t, r, n) {
			if (n.syncDynamicErrorWithStack)
				throw (
					(ei(e, n.syncDynamicErrorWithStack), new l.StaticGenBailoutError())
				);
			if (0 !== t) {
		...
		function ec(e, t, r, n, a) {
			...
			const { validationPreventingErrors: o } = r;
	...
	(e, t, r) => {
		...
		var n = {
			...
			unstable_isUnrecognizedActionError: () =>
				l.unstable_isUnrecognizedActionError,
