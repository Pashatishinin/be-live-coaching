(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
	...
	(e) => {
		var t,
			...
			E = (e, t) =>
				(E =
					...
					((e, t) => {
						for (var r in t) Object.hasOwn(t, r) && (e[r] = t[r]);
					}))(e, t);
		function g(e, t) {
		...
		function T(e, t) {
			var r = t && t.cache ? t.cache : A,
				n = t && t.serializer ? t.serializer : v;
			return (
				t && t.strategy
					? t.strategy
					: function (e, t) {
		...
		var v = function () {
			...
			B = {
				variadic: function (e, t) {
					var r, n;
					return (
						(r = t.cache.create()), (n = t.serializer), H.bind(this, e, r, n)
					);
				},
				monadic: function (e, t) {
					var r, n;
					return (
						(r = t.cache.create()), (n = t.serializer), d.bind(this, e, r, n)
					);
				},
			};
		function S(e) {
		...
		var X =
			...
			Z = new RegExp("^".concat(G.source, "*")),
			Y = new RegExp("".concat(G.source, "*$"));
		function W(e, t) {
		...
		try {
			er =
				(null ==
				(l = eu("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu").exec("a"))
					? void 0
					: l[0]) === "a";
		} catch (e) {
			er = !1;
		...
		var en = z
				? (e, t, r) => e.startsWith(t, r)
				: (e, t, r) => e.slice(r, r + t.length) === t,
			ei = Q
			...
			ea = $ ? (e) => e.trimStart() : (e) => e.replace(Z, ""),
			eh = ee ? (e) => e.trimEnd() : (e) => e.replace(Y, "");
		function eu(e, t) {
			return new RegExp(e, t);
		}
		if (er) {
			var el = eu("([^\\p{White_Space}\\p{Pattern_Syntax}]*)", "yu");
			c = (e, t) => {
				var r;
				return (el.lastIndex = t), null != (r = el.exec(e)[1]) ? r : "";
			};
		} else
			c = (e, t) => {
				for (var r = []; ; ) {
		...
		var ec = (() => {
			...
			return (
				...
				(e.prototype.parseMessage = function (e, t, r) {
					for (var n = []; !this.isEOF(); ) {
						...
						if (123 === i) {
							...
							this.bump(),
								n.push({ type: h.pound, location: W(s, this.clonePosition()) });
						} else if (60 !== i || this.ignoreTag || 47 !== this.peek())
							if (60 === i && !this.ignoreTag && ef(this.peek() || 0)) {
				...
				(e.prototype.parseTag = function (e, t) {
					...
					if (!this.bumpIf(">"))
						return this.error(a.INVALID_TAG, W(r, this.clonePosition()));
					var i = this.parseMessage(e + 1, t, !0);
					if (i.err) return i;
					var o = i.val,
						s = this.clonePosition();
					if (!this.bumpIf("</"))
						return this.error(a.UNCLOSED_TAG, W(r, this.clonePosition()));
					if (this.isEOF() || !ef(this.char()))
						return this.error(a.INVALID_TAG, W(s, this.clonePosition()));
					var u = this.clonePosition();
					return n !== this.parseTagName()
						? this.error(a.UNMATCHED_CLOSING_TAG, W(u, this.clonePosition()))
						: (this.bumpSpace(), this.bumpIf(">"))
							...
							: this.error(a.INVALID_TAG, W(s, this.clonePosition()));
				}),
				...
				(e.prototype.tryParseLeftAngleBracket = function () {
					...
					return this.isEOF() ||
						60 !== this.char() ||
						(!this.ignoreTag && (ef((e = this.peek() || 0)) || 47 === e))
						? null
						: (this.bump(), "<");
				}),
				...
				(e.prototype.parseArgument = function (e, t) {
					...
					if (125 === this.char())
						return (
							this.bump(),
							this.error(a.EMPTY_ARGUMENT, W(r, this.clonePosition()))
						);
					var n = this.parseIdentifierIfPossible().value;
					if (!n)
						return this.error(a.MALFORMED_ARGUMENT, W(r, this.clonePosition()));
				...
				(e.prototype.parseArgumentOptions = function (e, t, r, n) {
					...
					switch (s) {
						case "":
							return this.error(a.EXPECT_ARGUMENT_TYPE, W(o, l));
						case "number":
						case "date":
						case "time": {
							this.bumpSpace();
							...
							if (this.bumpIf(",")) {
								...
								c = { style: m, styleLocation: W(f, this.clonePosition()) };
							}
							var E = this.tryParseArgumentClose(n);
							if (E.err) return E;
							var g = W(n, this.clonePosition());
							if (c && en(null == c ? void 0 : c.style, "::", 0)) {
								var y = ea(c.style.slice(2));
								if ("number" === s) {
						...
						case "select": {
							...
							var A = this.tryParsePluralOrSelectOptions(e, s, t, v);
							if (A.err) return A;
							var E = this.tryParseArgumentClose(n);
							if (E.err) return E;
						...
						default:
							return this.error(a.INVALID_ARGUMENT_TYPE, W(o, l));
					}
				}),
				...
				(e.prototype.parseNumberSkeletonFromString = function (e, t) {
					...
					try {
						r = ((e) => {
							...
							for (
								var t = e.split(U).filter((e) => e.length > 0), r = [], n = 0;
								n < t.length;
								n++
							) {
								var i = t[n].split("/");
								...
								? ((e) => {
										for (var t = {}, r = 0; r < e.length; r++) {
											...
											switch (n.stem) {
												...
												case "scientific":
													t = b(
														b(b({}, t), { notation: "scientific" }),
														n.options.reduce((e, t) => b(b({}, e), x(t)), {}),
													);
													continue;
												case "engineering":
													t = b(
														b(b({}, t), { notation: "engineering" }),
														n.options.reduce((e, t) => b(b({}, e), x(t)), {}),
													);
													continue;
												...
												case "integer-width":
													...
													n.options[0].replace(D, (e, r, n, i, o, s) => {
				...
				(e.prototype.tryParsePluralOrSelectOptions = function (e, t, r, n) {
					for (
						var i, o = !1, s = [], h = new Set(), u = n.value, l = n.location;
						;
					) {
						if (0 === u.length) {
						...
						if (E.err) return E;
						s.push([u, { value: m.val, location: W(p, this.clonePosition()) }]),
							h.add(u),
							this.bumpSpace(),
				...
				(e.prototype.bumpIf = function (e) {
					if (en(this.message, e, this.offset())) {
				...
				(e.prototype.bumpSpace = function () {
					for (; !this.isEOF() && ep(this.char()); ) this.bump();
				}),
		...
		function em(e, t) {
			...
			var r = new ec(
				e,
				(t = b({ shouldParseSkeletons: !0, requiresOtherClause: !0 }, t)),
			).parse();
			if (r.err) {
			...
			return (
				(null == t ? void 0 : t.captureLocation) ||
					(function e(t) {
						t.forEach((t) => {
							if ((delete t.location, P(t) || M(t)))
								for (var r in t.options)
									delete t.options[r].location, e(t.options[r].value);
							else
								(I(t) && C(t.style)) || ((N(t) || L(t)) && O(t.style))
		...
		((i = f || (f = {})).MISSING_VALUE = "MISSING_VALUE"),
			...
			function e(t, r, n, i) {
				...
				if (
							...
							for (var u = [], l = 0; l < t.length; l++) {
								...
								if (R(c)) {
									var b = c.children,
										y = c.value,
										T = o[y];
									if ("function" != typeof T) throw new eb(y, "function", a);
									var d = T(e(b, r, n, i, o, s).map((e) => e.value));
									Array.isArray(d) || (d = [d]),
										u.push.apply(
											u,
											d.map((e) => ({
								...
								if (P(c)) {
									var H = c.options[E] || c.options.other;
									if (!H) throw new eg(c.value, E, Object.keys(c.options), a);
									u.push.apply(u, e(H.value, r, n, i, o));
									continue;
								}
								if (M(c)) {
									var H = c.options["=".concat(E)];
									if (!H) {
										if (!Intl.PluralRules)
											throw new eE(
										...
										var v = n
											...
											.select(E - (c.offset || 0));
										H = c.options[v] || c.options.other;
									}
									if (!H) throw new eg(c.value, E, Object.keys(c.options), a);
									u.push.apply(u, e(H.value, r, n, i, o, E - (c.offset || 0)));
								}
							}
							return u.length < 2
								? u
					...
					(this.resolvedOptions = () => {
						...
						return {
							locale:
								(null == (e = this.resolvedLocale) ? void 0 : e.toString()) ||
					...
					var u = i || {},
						l =
							...
							((e, t) => {
								var r = {};
								for (var n in e)
									Object.hasOwn(e, n) && 0 > t.indexOf(n) && (r[n] = e[n]);
								if (
									null != e &&
		...
		var ev =
			(((s = ev || {}).MISSING_MESSAGE = "MISSING_MESSAGE"),
		...
		function eN(e, t) {
			return eI((...t) => new e(...t), t);
		}
		function eL(e) {
			return {
				getDateTimeFormat: eN(Intl.DateTimeFormat, e.dateTime),
				getNumberFormat: eN(Intl.NumberFormat, e.number),
				getPluralRules: eN(Intl.PluralRules, e.pluralRules),
				getRelativeTimeFormat: eN(Intl.RelativeTimeFormat, e.relativeTime),
				getListFormat: eN(Intl.ListFormat, e.list),
				getDisplayNames: eN(Intl.DisplayNames, e.displayNames),
			};
		}
		function eP(e, t, r, n) {
			const i = e_(n, r);
		...
		var eR = e.i(43476);
		const eC = (0, m.createContext)(void 0);
		function eO() {
			const e = (0, m.useContext)(eC);
		...
		e.s(
			[
				...
				({
					...
					const h = (0, m.useContext)(eC),
						u = (0, m.useMemo)(() => h?.cache || eS(), [n, h?.cache]),
						l = (0, m.useMemo)(
							() => h?.formatters || eL(u),
							[u, h?.formatters],
						),
					...
					return (0, eR.jsx)(eC.Provider, { value: c, children: e });
				},
				"useFormatter",
				0,
				() => {
						...
						() =>
							((e) => {
								...
								function a(e) {
									return (
										e?.timeZone ||
											(s
												? (e = { ...e, timeZone: s })
												: o(new eH(ev.ENVIRONMENT_FALLBACK, void 0))),
										e
									);
								}
								function h(e, t, r, n, i) {
									...
									try {
										s = ((e, t, r) => {
											...
											if ("string" == typeof t) {
												if (!(n = e?.[t])) {
													const e = new eH(ev.MISSING_FORMAT, void 0);
													throw (o(e), e);
												}
											} else n = t;
											return r && (n = { ...n, ...r }), n;
									...
									try {
										...
										return o(new eH(ev.FORMATTING_ERROR, e.message)), i();
									}
								}
								function u(e, t, o) {
									return h(
								...
								function l() {
									return e.now
										? e.now
										: (o(new eH(ev.ENVIRONMENT_FALLBACK, void 0)), new Date());
								}
								return {
									dateTime: u,
									number: (e, t, o) =>
									...
									relativeTime: (e, t) => {
										try {
											...
											t instanceof Date || "number" == typeof t
												...
												o || (o = l());
											const u = (new Date(e).getTime() - o.getTime()) / 1e3;
											s ||
												(s =
													(a = Math.abs(u)) < 60
														? "second"
											...
											const c = ((n = s), Math.round(u / eM[n]));
											return r.getRelativeTimeFormat(i, h).format(c, s);
										} catch (t) {
											return (
												o(new eH(ev.FORMATTING_ERROR, t.message)), String(e)
											);
										}
									},
									list: (e, t, o) => {
									...
									dateTimeRange: (e, t, o, s) =>
										h(
											o,
											s,
											n?.dateTime,
											(n) => (
												(n = a(n)), r.getDateTimeFormat(i, n).formatRange(e, t)
											),
											() => [u(e), u(t)].join(" – "),
										),
								};
				...
				(e) =>
					((e, t) => {
						const {
							...
							u = e["!"],
							l = "!" === t ? void 0 : t.slice(2);
						return (
							h ||
								eG ||
								!eU ||
								((eG = !0), a(new eH(ev.ENVIRONMENT_FALLBACK, void 0))),
							(0, m.useMemo)(() => {
								var e;
								let t;
								return (
									(t = ((e, t, r) => {
										try {
											...
											const n = r ? eP(e, t, r) : t;
											if (!n) throw Error(r);
											return n;
										} catch (e) {
											return new eH(ev.MISSING_MESSAGE, e.message);
										}
									})(
										(e = {
											cache: r,
									...
									(({
										...
										function c(c, f, p, E) {
											...
											if (u) {
												if (!E)
													return a(o), n({ error: o, key: c, namespace: s });
												b = E;
											} else
												try {
													b = eP(i, o, c, s);
												} catch (e) {
													if (!E) return l(c, ev.MISSING_MESSAGE, e.message, E);
													b = E;
												}
											if ("object" == typeof b) {
												let e;
												return l(
													...
													Array.isArray(b)
														? ev.INVALID_MESSAGE
														: ev.INSUFFICIENT_PATH,
													e,
												);
											}
											const T = ((g = b), f || /'[{}]/.test(g) ? void 0 : g);
											if (T) return T;
											r.getMessageFormat ||
												(r.getMessageFormat = eI(
													(...e) =>
														new ed(e[0], e[1], e[2], {
															formatters: r,
															...e[3],
											...
											try {
												...
												return l(c, ev.INVALID_MESSAGE, e.message, E);
											}
											try {
												let e,
													t = y.format(
												...
												return l(c, ev.FORMATTING_ERROR, e.message, E);
											}
										}
										function f(e, t, r, n) {
											const i = c(e, t, r, n);
											return "string" != typeof i
												? l(e, ev.INVALID_MESSAGE, void 0)
												: i;
										}
										return (
											(f.rich = c),
											...
											(f.raw = (e) => {
												...
												try {
													...
													return l(e, ev.MISSING_MESSAGE, t.message);
												}
											}),
											(f.has = (e) => {
												if (u) return !1;
	...
	(e, t, r) => {
		...
		const n = e.r(55682)._(e.r(71645)).default.createContext(null);
	},
]);
